...
export function FAQPageClient() {
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          >
            <Accordion.Header>
              <Accordion.Trigger className="w-full flex items-center justify-between p-6 text-left hover:bg-muted transition-colors group">
                ...
                <ChevronDown className="w-5 h-5 text-accent transition-transform duration-200 group-data-[state=open]:rotate-180 shrink-0" />
              </Accordion.Trigger>
            </Accordion.Header>
      ...
      <div className="mt-12 text-center bg-linear-to-br from-[#FFE6ED] to-[#FFF4E6] rounded-3xl p-8">
