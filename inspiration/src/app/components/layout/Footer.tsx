    ...
    <footer className="bg-card border-t border-border mt-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><Link to="/shop/candles" className="text-muted-foreground hover:text-accent transition-colors">Candles</Link></li>
              <li><Link to="/shop/notebooks" className="text-muted-foreground hover:text-accent transition-colors">Notebooks</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><Link to="/about" className="text-muted-foreground hover:text-accent transition-colors">Our Story</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><a href="#" className="text-muted-foreground hover:text-accent transition-colors">Care Instructions</a></li>
            </ul>
          </div>
        </div>
        ...
        <div className="pt-8 border-t border-border text-center text-sm text-muted-foreground">
          <p>Made with <Heart className="w-4 h-4 inline text-accent" /> by PookieCrafts © 2026</p>
        </div>
      </div>
    </footer>
  );
